...
class Register extends React.Component {
    ...
    onSubmitRegister = () => {
        fetch('https://agile-everglades-51498.herokuapp.com/register', {
            method: 'post',
            ...
            <article className="br3 ba b--black-10 mv4 w-100 w-50-m w-25-l mw6 shadow-5 center">        
                <main className="pa4 black-80">
                    <div className="measure">
                        ...
                        <div className="">
                            <input className="b ph3 pv2 input-reset ba b--black bg-transparent grow pointer f6 dib" type="submit" onClick={onSubmitRegister} value="Register"/>
                        </div>
                    </div>
                </main>        
            </article>
